(function()
{
    ...
    var _options = {
            ...
            templates:{
                ...
                option: '<li><a class="option-item" href="javascript:void(0);"></a></li>',
    ...
    Select.prototype = {
        ...
        _bindEvents: function()
        {
            ...
            self.getElement('label').click(function(e)
            {
                e.stopPropagation();
            ...
            .on('focus', function()
            {
                self.getElement('label').parent('.js-select').addClass('focus');
            })
            .on('blur', function()
            {
                self.getElement('label').parent('.js-select').removeClass('focus');
            });
        },
